...
```{r echo=FALSE, fig.alt="image of copying the contents of the 01-heatmap.Rmd file and pasting in Claude to ask for a README file"}
ottrpal::include_slide("https://docs.google.com/presentation/d/119REsbbZS9w86txXu7GZKHegDnavgfxVDRg-WEXoBZE/edit?slide=id.g2fcf7903f51_0_2141#slide=id.g2fcf7903f51_0_2141")
```

<input type="checkbox"> Return to your browser (the Claude tab).<br/>
<input type="checkbox"> Ask Claude to create a README from the code. Paste (Cmd + V - Mac, Ctrl + V - Windows) in the code from `01-heatmap.Rmd`. You may want to do some variations on the prompt you use to ask Claude to do this to get good results.<br/>

```{r echo=FALSE, fig.alt="image of copying the response from Claude"}
ottrpal::include_slide("https://docs.google.com/presentation/d/119REsbbZS9w86txXu7GZKHegDnavgfxVDRg-WEXoBZE/edit?slide=id.g28aa6633ca3_0_28#slide=id.g28aa6633ca3_0_28")
```

<input type="checkbox"> Copy all the text from the desired Claude output (or Download a markdown file) and paste it to `README.md`. Save the file.  
...
<input type="checkbox"> Click another plus sign to the left of a change.<br/>
...
<input type="checkbox">  If needed, click `Show all checks`.<br/>
<input type="checkbox"> If no failing checks, Click the 3 dots at the end of the line that says `Render R Example / render-notebooks (pull_request)`. Click `View Details`<br/>
<input type="checkbox"> If failing checks, Click  `Details` at the end of the line that says `Render R Example / render-notebooks (pull_request)`<br/>
...
<input type="checkbox"> Return to GitHub Pull Request Online.<br/>
<input type="checkbox"> Click the `Merge` button.<br/>
